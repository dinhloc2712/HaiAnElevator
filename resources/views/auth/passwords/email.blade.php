...
<head>
    ...
    <title>Quên mật khẩu - Đăng Kiểm Tàu Cá</title>
...
<div class="login-card">
    <div class="text-center mb-4">
        ...
        <h4 class="text-primary fw-bold mb-1">QUÊN MẬT KHẨU</h4>
        <p class="text-muted small">Nhập email của bạn để nhận mã OTP</p>
    </div>
    ...
    <form action="{{ route('password.email') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <div class="input-group">
                ...
                <input type="email" name="email" class="form-control" required value="{{ old('email') }}" placeholder="Nhập email của bạn">
            </div>
        </div>
    ...
    <div class="text-center mt-3 border-top pt-3">
        <a href="{{ route('login') }}" class="text-primary small text-decoration-none fw-bold"><i class="fas fa-arrow-left me-1"></i> Quay lại Đăng nhập</a>
    </div>
</div>
