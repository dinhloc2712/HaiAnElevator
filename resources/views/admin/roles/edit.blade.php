                                        ...
                                        <td class="text-center {{ $permission ? 'cursor-pointer' : '' }}" onclick="{{ $permission ? 'toggleCheckbox(event, \'perm_' . $permission->id . '\')' : '' }}" style="{{ $permission ? 'cursor: pointer;' : '' }}">
                                            @if($permission)
                                                <div class="form-check d-inline-block">
                                                    <input class="form-check-input module-permission" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="perm_{{ $permission->id }}" data-module="{{ $moduleKey }}" {{ in_array($permission->id, $rolePermissionIds) ? 'checked' : '' }}>
                                                </div>
                                            @else
