        ...
        <div class="p-3 border-bottom">
            <form method="GET" action="{{ route('admin.buildings.index') }}">
                <div class="search-wrap">
                    ...
                    <input type="text" name="search" class="search-input" placeholder="Tìm kiếm tòa nhà, khách hàng..."
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end gap-1">
                                    <a href="{{ route('admin.buildings.edit', $building) }}" class="action-btn edit"
                                        title="Chỉnh sửa">
                ...
                <form action="{{ route('admin.buildings.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="file" class="form-control shadow-none" id="file" required
                                accept=".xlsx, .xls, .csv">
                            <div class="form-text mt-2">Định dạng hỗ trợ: .xlsx, .xls, .csv (Tối đa 10MB)</div>
                        </div>

                        <div class="bg-light p-3 rounded-3">
                            <p class="mb-2 fw-semibold small text-primary"><i class="fas fa-info-circle me-1"></i> Thứ tự
                                các cột trong file:</p>
                            <div class="row g-2">
                                <div class="col-12"><span class="badge bg-white text-dark border fw-normal">Cột 1</span>
                                    Tên tòa nhà <span class="text-danger">*</span></div>
                                <div class="col-12"><span class="badge bg-white text-dark border fw-normal">Cột 2</span>
                                    Tên khách hàng</div>
                                <div class="col-12"><span class="badge bg-white text-dark border fw-normal">Cột 3</span>
                                    Địa chỉ</div>
                                <div class="col-12"><span class="badge bg-white text-dark border fw-normal">Cột 4</span>
                                    Người liên hệ</div>
                                <div class="col-12"><span class="badge bg-white text-dark border fw-normal">Cột 5</span>
                                    Số điện thoại</div>
                                <div class="col-12"><span class="badge bg-white text-dark border fw-normal">Cột 6</span>
                                    Ghi chú</div>
                            </div>
                        </div>
                    </div>
