...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 fw-bold mb-1">Chỉnh sửa tòa nhà</h1>
        <p class="text-muted small mb-0">Cập nhật thông tin: <strong>{{ $building->name }}</strong></p>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="customer_name" class="form-control"
                           value="{{ old('customer_name', $building->customer_name) }}">
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="contact_name" class="form-control"
                           value="{{ old('contact_name', $building->contact_name) }}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="notes" class="form-control" rows="3">{{ old('notes', $building->notes) }}</textarea>
                </div>
            </div>
        </div>
